...
<div class ="container">
    ...
    <!-- <form action="" method="post">
        <table>
            ...
            <tr>
                <td>Password<input type="text" name="pass" id=""></td>
            </tr>
            <tr>
    ...
    <form action="" method="post">
        <div class="form-group">
            ...
            <input type="text" name="id" class="form-control" value="<?php echo ($_POST["id"]?$_POST["id"]:"")?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
        ...
        <div class="form-group">
            ...
            <small id="emailHelp" class="form-text text-muted">Nhập lại mật khẩu của bạn</small>
        </div>
        <button type="submit" name="submit" value="Login" class="btn btn-primary">Submit</button>
    </form>

    </div>
    <a href="index.php?ctrl=login&func=index"><button>Login</button></a>
    </div>
